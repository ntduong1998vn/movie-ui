...
module.exports = {
  ...
  "menu.wizard": "Wizard",
  "menu.episodes": "Tập phim",
  "menu.episode-list": "Danh sách tập phim",
  /* 04.Dashboards */
  ...
  "pages.header": "Header",
  "pages.details": "Chi tiết",
  "pages.orders": "ORDERS",
  "pages.imdb": "IMDb",
  "pages.releaseyear": "Năm phát hành",
  "pages.language": "Ngôn ngữ",
  "pages.nation": "Quốc gia",
  "pages.adult": "Độ tuổi",
  "pages.genres": "Thể loại",
  "pages.quality": "Chất lượng",
  "pages.order-status": "Order Status",
  "pages.bake-progress": "Bake Progress",
  "pages.popularity": "Popularity",
  "pages.comments": "Bình luận",
  "pages.edit": "Sửa",
  ...
  "pages.comments-title": "Bình luận",
  ...
  "pages.movie-edit": "Sửa phim",
  "pages.reviews": "Review",
  "pages.episodes": "Tập phim",
  /* 06.Applications */
  ...
  "forms.actor-avatar": "Ảnh đại diện",
  ...
  "forms.overview": "Giới thiệu",
  "forms.popularity": "Phổ biến",
  "forms.language": "Ngôn ngữ",
  "forms.poster": "Ảnh bìa",
  "forms.view": "Lượt xem",
  ...
  "form-components.dropzone-multi": "Dropzone Multi",
  "form-components.episode": "Tập phim",
  /* 07.12.Icons */
  ...
  // 08. Genre
  "genre.add-new-genre-title": "Thêm mới",
  "genre.genre-name": "Tên thể loại",
  "genre.add-new": "Thêm mới",
  "genre.cancel": "Hủy",
  "genre.submit": "Đồng ý",
  "genre.edit-genre-modal-title": "Sửa",
};
